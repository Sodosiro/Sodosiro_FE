export const Region = {
  ...
  reasons: [
    "국내 서핑 1번지, 초보자 강습부터 전문 스팟까지 다양해요",
    "죽도해변·인구해변 근처 감성 카페 거리가 잘 형성되어있어요",
    "설악산과 동해 바다를 하루에 모두 즐길 수 있어요",
  ],
  topAttractions: [
    {
      title: "하조대해수욕장",
    ...
    },
    {
      ...
      imageUrl:
        "https://tong.visitkorea.or.kr/cms/resource/41/4064941_image2_1.jpg",
    },
  ],
  recommendMonth: {
    startMonth: 6,
    endMonth: 9,
    reason: "서핑 시즌 · 해수욕장 개장 시기",
  },
